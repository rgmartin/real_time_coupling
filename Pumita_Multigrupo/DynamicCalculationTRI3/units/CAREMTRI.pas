...
const
  TamBloque=ng*(3+ng);    // Tamaño de uno de los 8 bloques que cada tabla tiene para cada quemado
  NMaxTablas = 18;        //Número máximo de tablas en el archivo externo
  LongTableLine0 = 8*TamBloque+1;//Tamaño de una fila (correspondiente a un quemado) de una tabla (correspondiente a un material)= valor de quemado + 8 bloques
  NumMaxLineasTabla = 49;  //Numero máximo de filas para una tabla = número de quemados predefinidos en cada tabla.

Type
  TipoCalculoType = (estatico, adiabatico, directo);
  TipoSeccionesEficaces = array[1..TamBloque] of real;
...
const
 ...
 //********************************************CONSTANTES DEPENDIENTES DE LA CANTIDAD DE GRUPOS ng ****************

  espectro_de_fision: GroupType = (0.999637, 0.000363,  0.0);

  VEL: array[1..ng] of real = (1.910885E+09,5733925.69,  240619.248); // falta poner aquí valores correctos
  ...
  ((0.990014383,9.986359E-03, 0),
   (0.990266625,9.733892E-03, 0),
   (0.991798423,8.202481E-03, 0),
   (0.993846384,6.153698E-03, 0),
   (0.99205253, 7.947202E-03, 0),
   (0.986967781,0.0130318594, 0));

   XS_REFL_Inf0: TipoSeccionesEficaces =
  (  2.26157E+00,  8.51778E-01,  3.18792E-01,  1.08406E-04,  6.19064E-02,
4.01692E-06,  0.00000E+00,  5.63644E-04,  7.91498E-02,  0.00000E+00,
1.68218E-03,  8.38636E-03,  0.00000E+00,  0.00000E+00,  0.00000E+00,
...
0.00000E+00,  0.00000E+00,  0.00000E+00);
 ...
 ((-4.97211E-01, 0.00000E+00, 0.00000E+00),
 ( 1.84148E-01,-4.21518E-01, 0.00000E+00),
 ( 4.33337E-02, 1.86478E-01,-2.68771E-01));
 ...
 ( 4.33337E-02, 1.86478E-01,-2.68771E-01));
    ...
    DBORO: array[1..TamBloque] of real =
(-1.956000E-07, 3.594000E-07,1.420900E-05,
  1.000000E-08,-2.600000E-07,8.000000E-19,
  0           , 1.500000E-08,5.100000E-12,
  0           , 1.500000E-08,5.100000E-12,
  2.800000E-08, 1.100000E-09,-3.000000E-07,
  9.000000E-09, 5.000000E-10,-1.100000E-07);
...
//*******************************************************/
 ...
 procedure ImprimirPuma (TTime,DT:real);
 ...
 begin
  ...
  if ImprimirFormatoPuma then begin
     writeln(F);
     writeln(F);
     if (DT=0) or (Ttime - (FrecuenciaImpresion*DT) * Int(TTime / (FrecuenciaImpresion*DT)) = 0.0) then
        ImprimirPuma(TTime,DT);
  end;
