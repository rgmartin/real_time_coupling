...
const
//-------------------------------SECCION DEPENDENTE DEL NUMERO DE GRUPOS NG-----------------------------
  espectro_de_fision: GroupType = (1.0,  0.0);                     // Modificar si ng != 5
  VEL: array[1..ng] of real = (1.910885E+09, 240619.248);     // Modificar si ng != 5
  ...
  (1.75753E+00,  3.18792E-01,  2.71166E-04,  2.83008E-02,  1.68218E-03,
8.38636E-03,  0.00000E+00,  0.00000E+00,  0.00000E+00,  0.00000E+00);
...
8.38636E-03,  0.00000E+00,  0.00000E+00,  0.00000E+00,  0.00000E+00);
 ...
 ((-4.97211E-01, 0.00000E+00),
  ( 1.84148E-01,-4.21518E-01));

   alfaaxialSup0: MatRespType =    // Modificar si ng != 5
 ((-4.99999E-01, 0.00000E+00),
  ( 1.82907E-01,-4.22387E-01));

    DBORO: array[1..TamBloque] of real =  // Modificar esto si ng != 5
(-1.956000E-07, 3.594000E-07,
  1.000000E-08,-2.600000E-07,
  0           , 1.500000E-08,
  2.800000E-08, 1.100000E-09,
  9.000000E-09, 5.000000E-10);

//------------------------------FIN DE LA SECCION DEPENDIENTE DEL NUMERO DE GRUPOS NG--------
