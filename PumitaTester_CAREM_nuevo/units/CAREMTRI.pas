...
begin
  ...
  for trozo:=1 to 14 do begin
    ...
    for CASO:=false to Fraccionar do begin
      ...
      if num_dedos = 0 then // si no hay barra
        if tipo = '1.8%' then NT := 1
        else if tipo = '3.1%' then
          if VQ = ' 0  ' then NT := 2
          else if VQ = ' 6VQ' then NT := 3
          else if VQ = '12VQ' then NT := 4;   //no se usa en CAREM actual

      if num_dedos = 12 then
        if tipo = '1.8%' then NT := 5
        else if tipo = '3.1%' then
          if VQ = ' 0  ' then NT := 6   //no se usa en carem actual
          else if VQ = ' 6VQ' then NT := 8 ; //no se usa en carem actual
